...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="POST" action="{{ route('store.process', $product) }}">
        @csrf
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                    ...
                    <div class="flex items-center space-x-3 mb-4 pb-4 border-b">
                        ...
                        @else
                            <div class="w-16 h-16 bg-gray-100 rounded flex items-center justify-center">👕</div>
                        @endif
                        <div>
                            <p class="font-medium text-sm">{{ $product->name }}</p>
                            <p class="text-xs text-gray-500">{{ $qty }} unit</p>
                        </div>
                    </div>
