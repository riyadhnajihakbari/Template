        ...
        <div class="lg:col-span-2">
            <div class="modern-card p-6">
                ...
                <div class="flex space-x-2 mb-4 overflow-x-auto pb-2">
                    ...
                    <button onclick="filterCategory('{{ $category->id }}')" class="category-btn px-4 py-2 rounded-lg bg-gray-200 text-gray-800 font-semibold whitespace-nowrap hover:bg-gray-300 transition-colors">
                        {{ $category->name }}
                    </button>
                    @endforeach
                </div>
                    ...
                    @foreach($categories as $category)
                        ...
                        <div class="menu-item-card cursor-pointer transition-all duration-300 hover:scale-105" 
                            ...
                            <div class="bg-white rounded-xl p-3 shadow-md hover:shadow-xl border-2 border-gray-100 hover:border-orange-300">
                                ...
                                <p class="text-orange-600 font-bold text-lg">Rp {{ number_format($item->price, 0, ',', '.') }}</p>
                                @if($item->stock > 0)
