            ...
            <table class="modern-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-sm">
                            <div class="flex items-center gap-2">
                                <span class="password-hidden font-mono text-gray-600" data-user="{{ $user->id }}">
                                    ••••••••
                                </span>
                                <span class="password-shown font-mono text-gray-800 font-semibold hidden" data-user="{{ $user->id }}">
                                ...
                                <button onclick="togglePassword({{ $user->id }})" 
                                    ...
                                    <span class="show-btn-{{ $user->id }}">👁️</span>
                                    <span class="hide-btn-{{ $user->id }} hidden">🙈</span>
                                </button>
                            </div>
                        </td>
                        <td>
