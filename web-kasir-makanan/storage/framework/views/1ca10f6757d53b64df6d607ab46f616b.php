    ...
    <div class="card mb-6">
        <div class="flex items-center space-x-2 overflow-x-auto">
            <a href="<?php echo e(route('menu.index')); ?>" 
               class="px-4 py-2 rounded-lg <?php echo e(!request('category') ? 'bg-pos-primary text-white' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'); ?> whitespace-nowrap">
                Semua
            </a>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('menu.index', ['category' => $category->id])); ?>" 
               class="px-4 py-2 rounded-lg <?php echo e(request('category') == $category->id ? 'bg-pos-primary text-white' : 'bg-gray-200 text-gray-800 hover:bg-gray-300'); ?> whitespace-nowrap">
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <form action="<?php echo e(route('menu.toggle-status', $item)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="px-3 py-1 rounded-full text-sm font-semibold <?php echo e($item->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="<?php echo e(route('menu.destroy', $item)); ?>" 
                                      method="POST" 
