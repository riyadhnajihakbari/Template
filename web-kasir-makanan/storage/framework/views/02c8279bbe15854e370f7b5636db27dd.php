        ...
        <aside class="w-64 glass-card shadow-2xl no-print border-r border-white/10">
            <div class="p-6 border-b border-white/10">
                ...
                <div class="rounded-lg p-3 mt-3">
                    <p class="text-sm text-gray-300 font-semibold"><?php echo e(auth()->user()->name); ?></p>
            ...
            <nav class="p-4 space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('dashboard') ? 'nav-active' : 'nav-link text-gray-300'); ?>">
                    <span class="text-xl">📊</span>
                    <span class="font-medium">Dashboard</span>
                </a>
                
                <a href="<?php echo e(route('pos.index')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('pos.*') ? 'nav-active' : 'nav-link text-gray-300'); ?>">
                    <span class="text-xl">💰</span>
                ...
                <a href="<?php echo e(route('menu.index')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('menu.*') ? 'nav-active' : 'nav-link text-gray-300'); ?>">
                    <span class="text-xl">🍔</span>
                    <span class="font-medium">Kelola Menu</span>
                </a>
                
                <a href="<?php echo e(route('reports.sales')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('reports.*') ? 'nav-active' : 'nav-link text-gray-300'); ?>">
                    <span class="text-xl">📈</span>
