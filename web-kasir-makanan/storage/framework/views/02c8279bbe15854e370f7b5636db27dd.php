        ...
        <aside class="w-64 modern-sidebar no-print">
            <div class="p-6 border-b border-gray-100">
                ...
                <div class="user-badge">
                    ...
                    <div>
                        ...
                        <span class="text-xs opacity-75"><?php echo e(ucfirst(auth()->user()->role)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-4 space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl <?php echo e(request()->routeIs('dashboard') ? 'nav-active' : 'nav-link text-gray-700'); ?>">
                    <span class="text-xl">📊</span>
                    <span class="font-medium">Dashboard</span>
                </a>
                
                <a href="<?php echo e(route('pos.index')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl <?php echo e(request()->routeIs('pos.*') ? 'nav-active' : 'nav-link text-gray-700'); ?>">
                    <span class="text-xl">💰</span>
                ...
                <a href="<?php echo e(route('menu.index')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl <?php echo e(request()->routeIs('menu.*') ? 'nav-active' : 'nav-link text-gray-700'); ?>">
                    <span class="text-xl">🍔</span>
                    <span class="font-medium">Kelola Menu</span>
                </a>
                
                <a href="<?php echo e(route('reports.sales')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl <?php echo e(request()->routeIs('reports.*') ? 'nav-active' : 'nav-link text-gray-700'); ?>">
                    <span class="text-xl">📈</span>
                ...
                <a href="<?php echo e(route('users.index')); ?>" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-xl <?php echo e(request()->routeIs('users.*') ? 'nav-active' : 'nav-link text-gray-700'); ?>">
                    <span class="text-xl">👥</span>
...
</html><?php /**PATH D:\Pribadi\LYNK\Template\web-kasir-makanan\resources\views/layouts/app.blade.php ENDPATH**/ ?>